...
/**
 * @author JustisR
 *     <p>Any questions, comments, or suggestions, feel free to contact me via skype at
 *     "xyourfreindx"
 */
public class JsonMessage {
  ...
  public void send(Player... p) {
    String nmsClass =
        ((!getServerVersion().startsWith("v1_7_R")) ? "IChatBaseComponent$" : "")
            + "ChatSerializer";
    for (Player pp : p) {
      try {
        ...
        Object packet =
            getNmsClass("PacketPlayOutChat")
                ...
                .newInstance(comp);
        Object handle = pp.getClass().getMethod("getHandle").invoke(pp);
  ...
  public static class JsonStringBuilder {
     ...
     *
     * @param ach the achievement to be displayed. for list of achievements, visit <a
     *     href="http://minecraft.gamepedia.com/Achievements">here</a>
     * @return the json string builder to which you are applying settings
     */
    public JsonStringBuilder setHoverAsAchievement(String ach) {
      hover =
          ",\"hoverEvent\":{\"action\":\"show_achievement\",\"value\":\"achievement."
              + esc(ach)
              + "\"}";
      return this;
    }
